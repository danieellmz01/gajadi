...
const intro = `Halo Kak ! @${memNumber} \n\n Welcome Kak\n\nIntro Dulu Dong...\nNama :\nUmur :\nGender : \nAsal :\n\nSemoga Betah Yaa dan Jangan Lupa Di Isi...\nAnd Following Rules Group`;
const outro = `Dadaah baik - baik ya disana \nKalo balik gua nitip - nitip nih\n\n\n ◉ Rest In Peace :') ◉`

const teksPromote = `Anjay jadi admin :v\nAwas aje kalo ga bertanggung jawab :v\n@${memNumber}`;
const teksDemote = `Yahaha kesiaan kena demote\nElu sih ga bertanggung jawab\n@${memNumber}`
...
buttonId: `y`, 
buttonText: { 
displayText: "Nitip Nasgor ama Seblak" },
type: 1 }
];        
